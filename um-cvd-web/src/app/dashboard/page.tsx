  ...
  if (isCompleted && predictionResult) {
    return (
      <div className="min-h-screen w-full flex">
        {/* Left Sidebar - Feature Importance (Hamburger Menu) */}
        <div className="w-80 bg-panel border-r border-black/10 flex-shrink-0 flex flex-col h-screen">
        ...
        {/* Right Content - All Results */}
        <div className="flex-1 flex flex-col">
          <main className="flex-1 px-6 py-8">
            <div className="bg-panel rounded-2xl border border-black/10 p-6 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-white">CVD Risk Assessment Results</h2>
                <button
                  onClick={() => {
                    setIsCompleted(false);
                    setPredictionResult(null);
