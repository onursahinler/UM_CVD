      ...
      {isLoading && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
          <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-8 shadow-2xl max-w-md w-full mx-4 text-center border border-white/20 animate-scale-in">
            ...
            <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 mb-2">Analyzing Patient Data</h3>
            <p className="text-gray-600 mb-6">Please wait while our AI model processes the information...</p>
